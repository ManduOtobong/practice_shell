...
/**
 * help_all - Displays all possible builtin sshell commands.
 */
void help_all(void)
{
...
/**
 * help_alias - Displays information on the sshell builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - Displays information on the sshell builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays information on the sshell builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays information on the sshell builtin command 'help'.
 */
void help_help(void)
{
	char *msg = "help: help\n\tSee all possible SShell builtin commands.\n";
